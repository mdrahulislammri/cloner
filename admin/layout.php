...
{
    return [
        'dashboard' => ['label' => 'Dashboard', 'href' => 'dashboard.php', 'icon' => 'fa-solid fa-gauge-high'],
        'services' => ['label' => 'Services', 'href' => 'services.php', 'icon' => 'fa-solid fa-screwdriver-wrench'],
        'portfolio' => ['label' => 'Portfolio', 'href' => 'portfolio.php', 'icon' => 'fa-regular fa-images'],
        'testimonials' => ['label' => 'Testimonials', 'href' => 'testimonials.php', 'icon' => 'fa-solid fa-star'],
        'settings' => ['label' => 'Settings', 'href' => 'settings.php', 'icon' => 'fa-solid fa-gear'],
        'messages' => ['label' => 'Messages', 'href' => 'messages.php', 'icon' => 'fa-regular fa-envelope'],
        'monitoring' => ['label' => 'Monitoring', 'href' => 'monitoring.php', 'icon' => 'fa-solid fa-chart-line'],
    ];
}
      ...
      <nav class="space-y-1">
        <?php foreach ($items as $key => $item): ?>
          ...
          <a href="<?= htmlspecialchars($item['href']) ?>" class="flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold <?= $isActive ? 'bg-emerald-700 text-white' : 'text-emerald-100 hover:bg-emerald-800' ?>">
            <i class="<?= htmlspecialchars($item['icon']) ?> w-4 text-center" aria-hidden="true"></i>
